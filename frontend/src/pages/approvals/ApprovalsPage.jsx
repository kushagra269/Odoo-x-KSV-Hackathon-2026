  ...
  const approvalMutation = useMutation({
    ...
    onSuccess: (_, variables) => {
      ...
      pushToast({
        ...
        title: variables.action === "approve" ? "Approval saved" : "Request rejected",
        description: "The workflow state was updated in the backend.",
      });
    },
  });
  const currentStep = approval?.steps?.find((step) => step.id === approval?.current_step_id);
        ...
        <div className="two-column approval-layout">
          ...
          <SurfaceCard className="nested-card">
            ...
            <div className="page-actions page-actions--inline">
              <Button
                disabled={!approval || !currentStep || isFinal || approvalMutation.isPending}
                onClick={() =>
              ...
              >
                {approvalMutation.isPending ? "Saving..." : "Approve"}
              </Button>
              <Button
                variant="secondary"
                disabled={!approval || !currentStep || isFinal || approvalMutation.isPending}
