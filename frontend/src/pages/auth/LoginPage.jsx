...
export function LoginPage() {
  ...
  const loginMutation = useMutation({
    ...
    onError: (error) => {
      const message = error?.response?.data?.error || error?.response?.data?.message || "Please recheck your credentials and try again.";
      pushToast({
        tone: "danger",
        title: "Login failed",
        description: message,
  ...
  const loginError =
    ...
    (loginMutation.isError ? "Please recheck your credentials and try again." : "");
    ...
    <div className="auth-page">
      ...
      <div className="auth-card">
        ...
        <form onSubmit={handleSubmit((values) => loginMutation.mutate(values))} className="auth-card__form">
          ...
          {loginError ? <div className="form-alert form-alert--danger">{loginError}</div> : null}
